...
const router = createRouter({
  ...
  routes: [
    ...
    { path: "/account/orders", name: "orders", component: () => import("../views/OrdersView.vue"), meta: { title: "Order History", requiresAuth: true } },
    { path: "/account/orders/:number", name: "order-detail", component: () => import("../views/OrderDetailView.vue"), meta: { title: "Order", requiresAuth: true } },
